...
% in a bipartite graph that exhibit recurrent orbit.
tic;
close all;
clear all;
...
%Consider 1 and 3 are row agents, 2 and 4 as column agents. But 1 plays
%against 4 as a column agent which causes asymmetry that leads to chaos.
lambda1=1; %1
lambda2=1; %1 
lambda3=1; %1
lambda4=1; %1
